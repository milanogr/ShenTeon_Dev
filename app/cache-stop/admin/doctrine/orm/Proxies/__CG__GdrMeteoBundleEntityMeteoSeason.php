 ...
 */
class MeteoSeason extends \Gdr\MeteoBundle\Entity\MeteoSeason implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\MeteoSeason' . "\0" . 'id', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\MeteoSeason' . "\0" . 'name', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\MeteoSeason' . "\0" . 'combinations', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\MeteoSeason' . "\0" . 'months'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MeteoSeason $proxy) {
    ...
    public function addMonth(\Gdr\MeteoBundle\Entity\MeteoMonth $months)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addMonth', [$months]);
    ...
    public function removeMonth(\Gdr\MeteoBundle\Entity\MeteoMonth $months)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeMonth', [$months]);
