 ...
 */
class MeteoWind extends \Gdr\MeteoBundle\Entity\MeteoWind implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'isRandom', 'status', 'createdAt', 'image', 'imageName', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MeteoWind $proxy) {
    ...
    public function getIsRandom()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsRandom', []);

        return parent::getIsRandom();
    }
