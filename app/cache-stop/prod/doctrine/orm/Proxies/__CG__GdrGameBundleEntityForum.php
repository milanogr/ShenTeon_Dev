 ...
 */
class Forum extends \Gdr\GameBundle\Entity\Forum implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Forum' . "\0" . 'id', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Forum' . "\0" . 'name', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Forum' . "\0" . 'type', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Forum' . "\0" . 'enclave', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Forum' . "\0" . 'sorting', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Forum' . "\0" . 'allowSoul', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Forum' . "\0" . 'isActive'];
        }
