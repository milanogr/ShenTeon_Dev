 ...
 */
class MoonStatus extends \Gdr\MeteoBundle\Entity\MoonStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'moon', 'expiresAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MoonStatus $proxy) {
    ...
    public function setMoon(\Gdr\MeteoBundle\Entity\Moon $moon = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMoon', [$moon]);

        return parent::setMoon($moon);
    }
    ...
    public function getMoon()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMoon', []);

        return parent::getMoon();
    }
