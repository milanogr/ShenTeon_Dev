 ...
 */
class Language extends \Gdr\UserBundle\Entity\Language implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gdr\\UserBundle\\Entity\\Language' . "\0" . 'id', '' . "\0" . 'Gdr\\UserBundle\\Entity\\Language' . "\0" . 'race', '' . "\0" . 'Gdr\\UserBundle\\Entity\\Language' . "\0" . 'personage', '' . "\0" . 'Gdr\\UserBundle\\Entity\\Language' . "\0" . 'createdAt'];
        }
