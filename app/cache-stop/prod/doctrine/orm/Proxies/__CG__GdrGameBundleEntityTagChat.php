 ...
 */
class TagChat extends \Gdr\GameBundle\Entity\TagChat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', '' . "\0" . 'Gdr\\GameBundle\\Entity\\TagChat' . "\0" . 'location'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TagChat $proxy) {
