 ...
 */
class PropertyItem extends \Gdr\ItemsBundle\Entity\PropertyItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'property', 'item', 'quantity'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PropertyItem $proxy) {
