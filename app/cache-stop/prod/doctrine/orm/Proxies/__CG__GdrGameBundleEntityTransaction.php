 ...
 */
class Transaction extends \Gdr\GameBundle\Entity\Transaction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Transaction' . "\0" . 'id', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Transaction' . "\0" . 'subject', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Transaction' . "\0" . 'sender', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Transaction' . "\0" . 'type', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Transaction' . "\0" . 'amount', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Transaction' . "\0" . 'createdAt', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Transaction' . "\0" . 'isPlus', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Transaction' . "\0" . 'isHidden', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Transaction' . "\0" . 'note'];
        }
    ...
    public function setIsPlus($isPlus)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsPlus', [$isPlus]);

        return parent::setIsPlus($isPlus);
    }
    ...
    public function getIsPlus()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsPlus', []);

        return parent::getIsPlus();
    }
