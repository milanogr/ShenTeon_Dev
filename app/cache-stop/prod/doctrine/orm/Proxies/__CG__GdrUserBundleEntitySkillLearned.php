 ...
 */
class SkillLearned extends \Gdr\UserBundle\Entity\SkillLearned implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'skill', 'personage', 'canUseAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SkillLearned $proxy) {
    ...
    public function setCanUseAt($canUseAt)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCanUseAt', [$canUseAt]);

        return parent::setCanUseAt($canUseAt);
    }
    ...
    public function getCanUseAt()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCanUseAt', []);

        return parent::getCanUseAt();
    }
