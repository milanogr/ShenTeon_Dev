 ...
 */
class LetterBackground extends \Gdr\GameBundle\Entity\LetterBackground implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'price', 'image', 'imageName', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LetterBackground $proxy) {
