 ...
 */
class Editto extends \Gdr\GameBundle\Entity\Editto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Editto' . "\0" . 'id', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Editto' . "\0" . 'name', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Editto' . "\0" . 'sort', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Editto' . "\0" . 'body'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Editto $proxy) {
