 ...
 */
class ThreadReaded extends \Gdr\GameBundle\Entity\ThreadReaded implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gdr\\GameBundle\\Entity\\ThreadReaded' . "\0" . 'id', '' . "\0" . 'Gdr\\GameBundle\\Entity\\ThreadReaded' . "\0" . 'personage', '' . "\0" . 'Gdr\\GameBundle\\Entity\\ThreadReaded' . "\0" . 'thread', '' . "\0" . 'Gdr\\GameBundle\\Entity\\ThreadReaded' . "\0" . 'isReaded'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ThreadReaded $proxy) {
    ...
    public function setIsReaded($isReaded)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsReaded', [$isReaded]);

        return parent::setIsReaded($isReaded);
    }
    ...
    public function getIsReaded()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsReaded', []);

        return parent::getIsReaded();
    }
