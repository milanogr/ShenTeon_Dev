 ...
 */
class EnclaveLevel extends \Gdr\GameBundle\Entity\EnclaveLevel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'icon', 'iconName', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EnclaveLevel $proxy) {
