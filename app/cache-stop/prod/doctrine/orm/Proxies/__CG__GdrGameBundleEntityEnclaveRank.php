 ...
 */
class EnclaveRank extends \Gdr\GameBundle\Entity\EnclaveRank implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'icon', 'iconName', 'level', 'enclave', 'isMaster', 'isViceMaster', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EnclaveRank $proxy) {
    ...
    public function getIsViceMaster()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsViceMaster', []);

        return parent::getIsViceMaster();
    }
    ...
    public function setIsViceMaster($isViceMaster)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsViceMaster', [$isViceMaster]);

        return parent::setIsViceMaster($isViceMaster);
    }
