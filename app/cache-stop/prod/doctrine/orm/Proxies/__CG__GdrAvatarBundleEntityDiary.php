 ...
 */
class Diary extends \Gdr\AvatarBundle\Entity\Diary implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gdr\\AvatarBundle\\Entity\\Diary' . "\0" . 'id', '' . "\0" . 'Gdr\\AvatarBundle\\Entity\\Diary' . "\0" . 'title', '' . "\0" . 'Gdr\\AvatarBundle\\Entity\\Diary' . "\0" . 'body', '' . "\0" . 'Gdr\\AvatarBundle\\Entity\\Diary' . "\0" . 'createdAt', '' . "\0" . 'Gdr\\AvatarBundle\\Entity\\Diary' . "\0" . 'personage', '' . "\0" . 'Gdr\\AvatarBundle\\Entity\\Diary' . "\0" . 'isHidden'];
        }
