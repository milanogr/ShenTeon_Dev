 ...
 */
class Title extends \Gdr\UserBundle\Entity\Title implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gdr\\UserBundle\\Entity\\Title' . "\0" . 'id', '' . "\0" . 'Gdr\\UserBundle\\Entity\\Title' . "\0" . 'name', '' . "\0" . 'Gdr\\UserBundle\\Entity\\Title' . "\0" . 'personage', '' . "\0" . 'Gdr\\UserBundle\\Entity\\Title' . "\0" . 'sort', 'icon', '' . "\0" . 'Gdr\\UserBundle\\Entity\\Title' . "\0" . 'iconName', '' . "\0" . 'Gdr\\UserBundle\\Entity\\Title' . "\0" . 'updatedAt'];
        }
