 ...
 */
class MeteoCombination extends \Gdr\MeteoBundle\Entity\MeteoCombination implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\MeteoCombination' . "\0" . 'id', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\MeteoCombination' . "\0" . 'name', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\MeteoCombination' . "\0" . 'season', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\MeteoCombination' . "\0" . 'condition', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\MeteoCombination' . "\0" . 'percentage'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MeteoCombination $proxy) {
