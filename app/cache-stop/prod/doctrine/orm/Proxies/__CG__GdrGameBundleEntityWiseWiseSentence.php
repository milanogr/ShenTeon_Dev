 ...
 */
class WiseSentence extends \Gdr\GameBundle\Entity\Wise\WiseSentence implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Wise\\WiseSentence' . "\0" . 'id', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Wise\\WiseSentence' . "\0" . 'body', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Wise\\WiseSentence' . "\0" . 'tags', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Wise\\WiseSentence' . "\0" . 'createdAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WiseSentence $proxy) {
