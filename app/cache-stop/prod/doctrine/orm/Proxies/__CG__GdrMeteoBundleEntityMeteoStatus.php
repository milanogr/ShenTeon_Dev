 ...
 */
class MeteoStatus extends \Gdr\MeteoBundle\Entity\MeteoStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'condition', 'wind', 'temp', 'isFixed', 'expiresAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MeteoStatus $proxy) {
    ...
    public function setWind(\Gdr\MeteoBundle\Entity\MeteoWind $wind = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setWind', [$wind]);

        return parent::setWind($wind);
    }
    ...
    public function getWind()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getWind', []);

        return parent::getWind();
    }
