 ...
 */
class Moon extends \Gdr\MeteoBundle\Entity\Moon implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\Moon' . "\0" . 'id', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\Moon' . "\0" . 'name', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\Moon' . "\0" . 'duration', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\Moon' . "\0" . 'sort', 'image', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\Moon' . "\0" . 'imageName', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\Moon' . "\0" . 'status', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\Moon' . "\0" . 'updatedAt', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\Moon' . "\0" . 'changeWolf'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Moon $proxy) {
    ...
    public function getChangeWolf()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getChangeWolf', []);

        return parent::getChangeWolf();
    }
    ...
    public function setChangeWolf($changeWolf)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setChangeWolf', [$changeWolf]);

        return parent::setChangeWolf($changeWolf);
    }
