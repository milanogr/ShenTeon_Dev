 ...
 */
class MeteoMessage extends \Gdr\MeteoBundle\Entity\MeteoMessage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\MeteoMessage' . "\0" . 'id', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\MeteoMessage' . "\0" . 'start', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\MeteoMessage' . "\0" . 'end', '' . "\0" . 'Gdr\\MeteoBundle\\Entity\\MeteoMessage' . "\0" . 'message'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MeteoMessage $proxy) {
