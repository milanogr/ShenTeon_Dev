 ...
 */
class Upload extends \Gdr\AdministrationBundle\Entity\Upload implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'image', 'imageName', 'updatedAt'];
        }
