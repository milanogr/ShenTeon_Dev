 ...
 */
class Test extends \Gdr\GameBundle\Entity\Test implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gdr\\GameBundle\\Entity\\Test' . "\0" . 'temp', 'id', 'name', 'path', 'file'];
        }
