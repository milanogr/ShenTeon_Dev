 ...
 */
class CombatSet extends \Gdr\GameBundle\Entity\CombatSet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gdr\\GameBundle\\Entity\\CombatSet' . "\0" . 'id', '' . "\0" . 'Gdr\\GameBundle\\Entity\\CombatSet' . "\0" . 'name', 'image', '' . "\0" . 'Gdr\\GameBundle\\Entity\\CombatSet' . "\0" . 'imageName', '' . "\0" . 'Gdr\\GameBundle\\Entity\\CombatSet' . "\0" . 'sort', '' . "\0" . 'Gdr\\GameBundle\\Entity\\CombatSet' . "\0" . 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CombatSet $proxy) {
