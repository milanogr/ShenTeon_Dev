 ...
 */
class FollowThread extends \Gdr\GameBundle\Entity\FollowThread implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gdr\\GameBundle\\Entity\\FollowThread' . "\0" . 'id', '' . "\0" . 'Gdr\\GameBundle\\Entity\\FollowThread' . "\0" . 'personage', '' . "\0" . 'Gdr\\GameBundle\\Entity\\FollowThread' . "\0" . 'thread', '' . "\0" . 'Gdr\\GameBundle\\Entity\\FollowThread' . "\0" . 'isNotified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FollowThread $proxy) {
    ...
    public function setIsNotified($isNotified)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsNotified', [$isNotified]);

        return parent::setIsNotified($isNotified);
    }
    ...
    public function getIsNotified()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsNotified', []);
