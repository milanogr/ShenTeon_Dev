 ...
 */
class LoginArchive extends \Gdr\GameBundle\Entity\LoginArchive implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'ip', 'createdAt', 'personage', 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LoginArchive $proxy) {
