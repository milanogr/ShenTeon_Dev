...
$catalogue = new MessageCatalogue('it', array (
  ...
  'messages' => 
  array (
    'Bad credentials' => 'Email e/o Password non valide',
  ),
  'admin' => 
  array (
  ...
  'WisetagAdmin' => 
  array (
    'Property List' => 'Lista Tag',
    'Name' => 'Nome',
  ),
  'LocationAdmin' => 
  array (
    'Location List' => 'Lista delle location',
    'Name' => 'Nome',
    'Type' => 'Tipo',
    'Is Active' => 'Appare?',
    'Get Type Name' => 'Tipo',
    'Description' => 'Descrizione',
    'Allow Soul' => 'Permetti anime',
    'Map' => 'Immagine mappa',
    'Icon' => 'Immagine pallino',
    'Parent Map' => 'Mappa di appartenenza',
    'Description Map' => 'Descrizione mappa',
    'Require Key' => 'Richiede una chiave',
    'Is Closed' => 'Chat chiusa?',
    'Is Street' => 'E\' una via?',
    'Map Night Name' => 'Mappa notturna',
  ),
  'EnclaveRankAdmin' => 
  array (
    'Enclave Rank List' => 'Lista Icone Enclave',
    'Name' => 'Nome',
    'Level' => 'Livello',
    'Icon' => 'Icona',
    'Is Master' => 'E\' Master?',
    'Is Vice Master' => 'E\' Vice Master?',
  ),
  'TagChat' => 
  array (
    'Tag Chat List' => 'Lista dei tag delle chat',
    'Name' => 'Nome',
  ),
  'LetterBackgroundAdmin' => 
  array (
    'Letter Background List' => 'Lista Sfondi Missive',
    'Name' => 'Nome',
    'Price' => 'Prezzo',
    'Image' => 'Sfondo',
  ),
  ...
  'EnclaveAdmin' => 
  array (
    'Enclave List' => 'Lista Enclavi',
    'Not Official' => 'Non istituzionalizzata',
    'Is Active' => 'E\' attiva?',
    'Is Clan' => 'E\' clan?',
    'Shield' => 'Scudo nella lista',
  ),
  'PropertyAdmin' => 
  array (
    'Property List' => 'Lista Immobili',
    'Name' => 'Nome',
    'Type' => 'Tipo',
    'Image' => 'Immagine',
    'Description' => 'Descrizione',
    ...
    'Quantity' => 'Quantità',
    'Tax' => 'Tassa in Mori',
    'Frequency Items' => 'Frequenza di produzione (giorni)',
    'Is Active' => 'Acquistabile?',
    'Get Type Name' => 'Tipo',
    'Items' => 'Oggetti',
    'Max People' => 'Max abitanti',
    'Chat Image' => 'Immagine per Chat',
  ),
  'RaceAdmin' => 
  array (
    'Race List' => 'Lista delle razze',
    'Male Image Name' => 'Avatar di default Uomo',
    'Female Image Name' => 'Avatar di default Donna',
    'Age Min' => 'Età min',
    'Age Max' => 'Età max',
    'Age Death' => 'Età morte',
    'Max Strength' => 'Forza mx',
    'Max Wisdom' => 'Saggezza max',
    'Min Height' => 'Altezza min',
    'Min Weight' => 'Peso min',
    'Max Weight' => 'Peso max',
    'Month To Older' => 'Mesi invecchiamento',
    'Use Race Language' => 'Lingua di razza',
    'Male Real Icon' => 'Icona razza reale maschio',
    'Female Real Icon' => 'Icona razza reale femmina',
    'Is Werewolf' => 'E\' un Mannaro?',
  ),
  'GdrAdministrationBundle' => 
  array (
    'title_dashboard' => 'Dashboard',
    'dashboard_link_title' => 'Dashboard',
    'breadcrumb.link_eye_color_list' => 'Fottiti',
    'form.label_name' => 'Test',
    'breadcrumb.link_enclave_rank_list' => 'test',
  ),
  'EsilioAdmin' => 
  array (
    'Esilio List' => 'Lista Esiliati',
    'Reason' => 'Motivo',
    'Days' => 'Giorni',
    'Until' => 'Fino al',
    'Is Account Banned' => 'Tutti i PG',
  ...
  array (
    ...
    'Personage' => 'Nome Personaggio',
    'Icon' => 'Simbolo',
    'Sort' => 'Ordine',
  ),
  'ForumCategoryAdmin' => 
  array (
    'Forum Category List' => 'Lista Categorie Forum',
    'Name' => 'Nome',
    'Is Active' => 'E\' visibile?',
    'Level Min' => 'Livello minimo',
    'Description' => 'Descrizione',
    'Is Junk' => 'E\' Cestino? (non toccare)',
    'Help Desk' => 'Help Desk',
    'Sort' => 'Ordine',
  ),
  'LibrarySectionAdmin' => 
  array (
    'Library Section List' => 'Lista sezioni della biblioteca',
    'Name' => 'Nome',
    'Sort' => 'Ordine',
    'Image' => 'Immagine',
    'Is Museo' => 'Museo?',
    'Is Archivio' => 'Archivio?',
  ),
  'LocationImageAdmin' => 
  array (
    'Location Image List' => 'Lista Immagini Location',
    'Condition' => 'Condizione Meteo',
    'For Night' => 'Immagine Notturna',
    'Image' => 'Immagine',
  ),
  'CombatSetAdmin' => 
  array (
    'Combat Set List' => 'Lista set combattimento',
    'Sort' => 'Ordine',
    'Name' => 'Nome',
    'Image' => 'Immagine',
  ),
  ...
  array (
    ...
    'Is News' => 'E\' una news del sito (non "ON")',
    'Is Archivio' => 'E\' una pagina di archivio (ON)',
  ),
  'MoonStatusAdmin' => 
  array (
    'Moon' => 'Luna',
    'Expires At' => 'Scadenza',
    'Moon Status List' => 'Lista stati',
  ),
  'MoonAdmin' => 
  array (
    'Duration' => 'Durata',
    ...
    'Image' => 'Immagine',
    'Name' => 'Nome',
    'Moon List' => 'Lista lune',
    'Change Wolf' => 'Trasforma i Mannari',
  ),
  'PersonageTypeAdmin' => 
  array (
    'Personage Type List' => 'Lista personaggi speciali',
    'Personage' => 'Personaggio',
    'Is Gestore' => 'E\' gestore',
    'Is Moderatore' => 'E\' moderatore',
    'Is Guida' => 'E\' informatore',
  ),
  'PropertyItemAdmin' => 
  array (
    'Property Item List' => 'Assegna oggetti',
    'Item' => 'Oggetto',
    'Property' => 'Immobile',
    'Quantity' => 'Quantità',
  ),
  'WiseSentenceAdmin' => 
  array (
    'Property List' => 'Lista Frasi Saggio',
    'Body' => 'Testo',
  ),
  'ItemAdmin' => 
  array (
    'Item List' => 'Lista Oggetti',
    'Can Araldo' => 'E\' Araldo',
    'Can Access Location' => 'E\' una Chiave per:',
    'Remove On Death' => 'Elimina dall\'inventario alla morte',
    'Is Base Item' => 'Inserisci alla registrazione',
    'Image' => 'Immagine',
    'Active Description' => 'Descrizione attiva',
    'Allow Soul' => 'Consenti scrittura anime',
    'Name' => 'Nome',
    'Type' => 'Tipo',
    'Short Description' => 'Descrizione breve',
    'Is Sellable' => 'E\' Vendibile?',
    'Price' => 'Prezzo',
    'Quantity' => 'Quantità',
    'Get Market Name' => 'Mercato',
    'Level' => 'Livello',
    'Market' => 'Mercato',
    'Can Marry' => 'Può Sposare',
  ),
  'ForbiddenNameAdmin' => 
  array (
    'Forbidden Name List' => 'Lista nomi proibiti',
    'Name' => 'Nome',
  ),
  'LibraryBookAdmin' => 
  array (
    'Library Book List' => 'Lista libri in biblioteca',
    'Title' => 'Titolo',
    'Author' => 'Autore',
    'Section' => 'Sezione',
    'Sort' => 'Ordine',
  ...
  array (
    'Nome' => 'Nome',
    'Skill List' => 'Lista delle Skill',
    'Is Random' => 'E\' Random?',
  ),
  'ManualeAdmin' => 
  array (
    'Manuale List' => 'Lista manuali',
    'Title' => 'Titolo',
    'Sort' => 'Ordine',
    'Active' => 'Attivo?',
    'Body' => 'Testo',
    'Is For Site' => 'Visibile sul sito',
  ),
  'MeteoWindAdmin' => 
  array (
    'Name' => 'Nome',
    'Is Random' => 'Random',
    'Meteo Wind List' => 'Lista venti',
    'Image' => 'Immagine',
  ),
  'UploadAdmin' => 
  array (
    'Name' => 'Nome',
    'Image' => 'Immagini',
    'Upload List' => 'Lista upload',
  ),
  'LanguageAdmin' => 
  array (
    'Language List' => 'Lista delle lingue imparate',
    'Personage' => 'Personaggio',
    'Race' => 'Razza',
  ),
  'LetterAdmin' => 
  array (
    'Sender' => 'ID mittente',
    'Sender Name' => 'Mittente',
    'Receiver' => 'Destinatario',
    'Body' => 'Testo',
    'Is Read' => 'Letta?',
    'Is Deletet' => 'Cancellata?',
  ),
  'ForumAdmin' => 
  array (
    'Forum List' => 'Lista dei Forum',
    'Name' => 'Nome',
    'Is Active' => 'E\' visibile?',
    'Type' => 'Tipo',
    'Sorting' => 'Ordine',
    'Allow Soul' => 'Le anime scrivono',
  ),
  'itemTypeAdmin' => 
  array (
    'Name' => 'Nome',
    'Markets' => 'Mercato di apparteneza',
    'Hide From Markets' => 'Nascondi dal mercato',
    'Show In Chat' => 'Mostra in chat (tooltip)',
    'Image' => 'Immagine',
  ),
  'AchievementAdmin' => 
  array (
    'Achivement List' => 'Lista Riconoscimenti',
    'Name' => 'Nome',
    'Description' => 'Descrizione',
    'Image' => 'Immagine',
    'Created At' => 'Creato il',
    'Update At' => 'Aggiornato il',
  ),
  'eyeColor' => 
  array (
    'breadcrumb.link_eye_color_list' => 'Fottiti',
  ...
  array (
    ...
    'Surname' => 'Cognome',
    'Death At' => 'Morto il',
    'In Family Grave' => 'Tomba di famiglia?',
    'Message' => 'Epigrafe',
    'Gravestone List' => 'Lista lapidi',
    'Death Age' => 'Morto a',
    'Type Year' => 'Tipo di anno',
    'Year' => 'Anno da visualizzare',
  ),
  'PersonageAdmin' => 
  array (
    'Race List' => 'Lista delle razze',
    ...
    'Female Real Icon' => 'Icona razza reale femmina',
    'Is Werewolf' => 'E\' un Mannaro?',
    'Global Experience' => 'Esperienza totale',
    'Title' => 'Titolo',
    'User' => 'Utente',
    'Name' => 'Nome',
    'Created At' => 'Data Registrazione',
    'Combat Points' => 'Punti combattimento spendibili',
    'Is Ex Warrior' => 'E\' stato un guerriero?',
    'Fate Note' => 'Note del fato',
  ),
  'MeteoMessageAdmin' => 
  array (
    'Message' => 'Messaggio',
    'Start' => 'Condizione di partenza',
    'End' => 'Condizione finale',
    'Meteo Message List' => 'Lista messaggi',
  ),
  'MeteoConditionAdmin' => 
  array (
    'Name' => 'Nome',
    'Meteo Condition List' => 'Lista condizioni',
    'Image' => 'Immagine giorno',
    'Image Night' => 'Immagine Notte',
  ),
  'MeteoMonthAdmin' => 
  array (
    'Name' => 'Nome',
    ...
    'Temp Max' => 'Massima',
    'Season' => 'Stagione',
    'Month Index' => 'Numero mese',
    'Meteo Month List' => 'Lista mesi',
  ),
  'MeteoStatusAdmin' => 
  array (
    ...
    'Expires At' => 'Scadenza',
    'Image' => 'Immagine',
    'Menu Status List' => 'Lista stati',
  ),
  'MeteoSeasonAdmin' => 
  array (
    'Meteo Season List' => 'Lista stagioni',
    'Name' => 'Nome',
  ),
  'MeteoCombinationAdmin' => 
  array (
    'Name' => 'Nome',
    'Month' => 'Mese',
    'Season' => 'Stagione',
    ...
    'Meteo Combination List' => 'Lista combinazioni',
  ),
));
