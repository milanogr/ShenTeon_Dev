...
class __TwigTemplate_63d95b056ffb053db9426a6b4c1645357baf7efd136bd3def7801d0e2b5bb667 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("GdrGameBundle:Default:innerContent.html.twig", "GdrGameBundle:Archivio:index.html.twig", 1);
        $this->blocks = array(
...
";
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        <h1><span>Archivio</span></h1>

        <p class=\"text-centered\">
            Benvenuto nell'Archivio di Teon. Tra gli scaffali delle sue stanze potrai trovare le Licenze Statutarie
            delle Enclavi nonché le notizie sulla storia di Teon dalla riapertura dei suoi confini.
        </p>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["section"]) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("archivio-show", array("id" => $this->getAttribute($context["section"], "getId", array()))), "html", null, true);
            echo "\"
                   title=\"Accedi alla ";
            // line 28
...
";
    ...
    {
        return "GdrGameBundle:Archivio:index.html.twig";
    }
...
/*                 <a class="gdrtooltip" href="{{ path("archivio-show", {id: section.getId}) }}"*/
