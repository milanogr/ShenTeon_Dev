...
class __TwigTemplate_123e9d90527ab9ed7cc693162456dc57e7695aa47a4847865af33d91c4cb34b7 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("@GdrGame/Library/index.html.twig", "GdrGameBundle:Library:show.html.twig", 1);
        $this->blocks = array(
    ...
    <p class=\"text-centered\">
        ...
        echo "\">Torna all'ingresso della Biblioteca</a>
    </p>
    ...
    ";
        ...
        <a class=\"show-book gdrtooltip\" data-href=\"";
            // line 16
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("biblioteca-show-book", array("id" => $this->getAttribute($context["book"], "id", array()))), "html", null, true);
            echo "\" title=\"Leggi ";
        ...
        ";
            // line 20
            if (((($this->getAttribute($context["loop"], "index", array()) % 10) == 0) || $this->getAttribute($context["loop"], "last", array()))) {
                // line 21
                echo "            </div>
        ";
            }
        ...
        ";
            // line 24
            if (((($this->getAttribute($context["loop"], "index", array()) % 10) == 0) && ($this->getAttribute($context["loop"], "last", array()) == false))) {
                // line 25
                echo "            <div class=\"ripiano\">
        ";
            }
...
";
    ...
    {
        return "GdrGameBundle:Library:show.html.twig";
    }
...
/*     <h2><span>Biblioteca - {{ section.getName }}</span></h2>*/
/* */
/*     <p class="text-centered">*/
/*         <a href="{{ path('biblioteca-index') }}">Torna all'ingresso della Biblioteca</a>*/
/*     </p>*/
/* */
/*     {% for book in books %}*/
/*         {% if loop.first %}*/
...
/*         {% endif %}*/
/* */
/*         <a class="show-book gdrtooltip" data-href="{{ path('biblioteca-show-book', {id: book.id}) }}" title="Leggi {{ book.title }}">*/
